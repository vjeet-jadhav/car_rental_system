                ...
                <div className='col-3  border-danger p-3 '>
                    <form action="">
                        ...
                        <div className='px-3 py-2 mt-2 border mx-2 rounded'>
                            ...
                            <div className='d-flex flex-column gap-3 px-3 mt-3'>
                                <div>
                                    <input type="checkbox" style={{transform: 'scale(1.3)'}}/> <span className=' px-2'>Manual</span>
                                </div>
                                <div>
                                    <input type="checkbox" style={{transform: 'scale(1.3)'}}/> <span className=' px-2'>Automatic</span>
                                </div>
                        ...
                        <div className='px-3 py-2 mt-2 border mx-2 rounded'>
                            ...
                            <div className='d-flex flex-column gap-3 px-3 mt-3'>
                                <div>
                                    <input type="checkbox" style={{transform: 'scale(1.3)'}}/> <span className=' px-2'>Petrol</span>
                                </div>
                                <div>
                                    <input type="checkbox" style={{transform: 'scale(1.3)'}}/> <span className=' px-2'>Diesel</span>
                                </div>
                                <div>
                                    <input type="checkbox" style={{transform: 'scale(1.3)'}}/> <span className=' px-2'>Electric</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className='px-3 py-2 mt-2 border mx-2 rounded'>
                            ...
                            <div className='d-flex flex-column gap-3 px-3 mt-3'>
                                <div>
                                    <input type="checkbox" style={{transform: 'scale(1.3)'}}/> <span className=' px-2'>4/5 Seaters</span>
                                </div>
                                <div>
                                    <input type="checkbox" style={{transform: 'scale(1.3)'}}/> <span className=' px-2'>6/7 Seaters</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className='px-3 py-2 mt-2 border mx-2 rounded'>
                            ...
                            <div className='d-flex flex-column gap-3 px-3 mt-3'>
                                <div>
                                    <input type="radio" style={{transform: 'scale(1.3)'}}/> <span className=' px-2'>4.5+ Rated</span>
                                </div>
                                <div>
                                    <input type="radio" style={{transform: 'scale(1.3)'}}/> <span className=' px-2'>4.0+ Rated</span>
                                </div>
                                <div>
                                    <input type="radio" style={{transform: 'scale(1.3)'}}/> <span className=' px-2'>3.5+ Rated</span>
                                </div>
                                <div>
                                    <input type="radio" style={{transform: 'scale(1.3)'}}/> <span className=' px-2'>All</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className='px-3 py-2 mt-2 border mx-2 d-flex justify-content-center align-content-center'>
                            <input type="submit" value="Apply Filter" className='btn btn-success fw-bold'/>
                        </div>
